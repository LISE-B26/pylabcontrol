"""
threading example, see https://joplaete.wordpress.com/2010/07/21/threading-with-pyqt4/
...
class MyApp(QtGui.QWidget):
 def __init__(self, parent=None):
  ...
  self.testButton.released.connect(lambda: self.test())
