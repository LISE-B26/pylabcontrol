...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_data_path = QtGui.QLineEdit(self.tab_data)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.tree_gui_settings.setEditTriggers(QtGui.QAbstractItemView.SelectedClicked)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1664, 21))
