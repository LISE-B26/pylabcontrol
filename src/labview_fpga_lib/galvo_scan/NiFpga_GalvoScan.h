 ...
 */
static const char* const NiFpga_GalvoScan_Signature = "ACFD06DA74AE6F37DB50C555DFA79EFE";

typedef enum
{
   NiFpga_GalvoScan_IndicatorBool_DMAtimeout = 0x56,
   NiFpga_GalvoScan_IndicatorBool_outputvalid = 0x2E,
   NiFpga_GalvoScan_IndicatorBool_running = 0x12,
} NiFpga_GalvoScan_IndicatorBool;

typedef enum
{
   NiFpga_GalvoScan_IndicatorI16_Detectorsignal = 0x5A,
} NiFpga_GalvoScan_IndicatorI16;

typedef enum
{
   NiFpga_GalvoScan_IndicatorI32_datasenttoDMA = 0x50,
   NiFpga_GalvoScan_IndicatorI32_failed = 0x1C,
   NiFpga_GalvoScan_IndicatorI32_i = 0x34,
   NiFpga_GalvoScan_IndicatorI32_ix = 0x40,
   NiFpga_GalvoScan_IndicatorI32_iy = 0x44,
   NiFpga_GalvoScan_IndicatorI32_number_pts_to_acquire = 0x18,
} NiFpga_GalvoScan_IndicatorI32;

typedef enum
{
   NiFpga_GalvoScan_IndicatorU32_DMA_elem_to_write = 0x20,
   NiFpga_GalvoScan_IndicatorU32_loop_time = 0x24,
} NiFpga_GalvoScan_IndicatorU32;

typedef enum
{
   NiFpga_GalvoScan_ControlBool_abort = 0x3E,
   NiFpga_GalvoScan_ControlBool_acquire = 0x4E,
   NiFpga_GalvoScan_ControlBool_stopfpga = 0x3A,
} NiFpga_GalvoScan_ControlBool;

typedef enum
{
   NiFpga_GalvoScan_ControlU8_detector_mode = 0x32,
   NiFpga_GalvoScan_ControlU8_measurements_per_pt = 0x2A,
   NiFpga_GalvoScan_ControlU8_scanmodex = 0x7A,
   NiFpga_GalvoScan_ControlU8_scanmodey = 0x4A,
} NiFpga_GalvoScan_ControlU8;

typedef enum
{
   NiFpga_GalvoScan_ControlI16_Connector1AO2 = 0x16,
